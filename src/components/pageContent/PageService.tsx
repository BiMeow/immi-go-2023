...
function PageService({ ...props }) {
  ...
  return (
    <>
      <div className={`PageService mainPage mb-[110px]`}>
        <img
        ...
        <div className="cusContainer relative z-10">
          <div className="heading mx-auto mb-[65px] max-w-[747px] text-center">
            ...
            <p className="text-[20px]">
              Khám phá gói giá của Immi Go: từ ngắn hạn đến dài hạn, chúng tôi
              đề xuất giá ưu đãi càng lâu, càng tiết kiệm.
              <br />
              Đầu tư một lần, tận hưởng lợi ích kéo dài và đưa bạn gần hơn với
              ước mơ Visa.
            </p>
          </div>
